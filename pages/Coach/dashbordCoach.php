  ...
  <aside class="hidden sm:flex sm:flex-col">
    ...
    <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
      <nav class="flex flex-col mx-4 my-6 space-y-4">
        <a href="#dashboard" class="inline-flex items-center justify-center py-3 text-purple-600 bg-white rounded-lg">
          <span class="sr-only">Dashboard</span>
          <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
        </a>
        <a href="#reservations" class="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
          <span class="sr-only">Réservations</span>
          <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
        </a>
        <a href="#disponibilites" class="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
          <span class="sr-only">Disponibilités</span>
          <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </a>
        <a href="#profil" class="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
    ...
    <main class="p-6 sm:p-10 space-y-6">
      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Disciplines enseignées</span>
          </div>
        </div>
        ...
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span class="block text-2xl font-bold">3</span>
            <span class="block text-gray-500">Certifications actives</span>
          </div>
        </div>
        ...
        <div class="row-span-3 bg-white shadow rounded-lg">
          <div class="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
            ...
            <span class="inline-flex items-center justify-center h-6 w-6 text-xs font-semibold text-white bg-red-500 rounded-full">5</span>
          </div>
          <div class="overflow-y-auto" style="max-height: 24rem;">
            <ul class="p-6 space-y-6">
              <li class="border-l-4 border-yellow-500 pl-4 py-2">
                <div class="flex items-center mb-2">
                  <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                    <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png" alt="Sportif">
                  </div>
                  <div>
                    <span class="font-semibold block">Ahmed Tazi</span>
                    <span class="text-sm text-gray-600">Football</span>
                  </div>
                </div>
                <p class="text-sm text-gray-600 mb-2">17 Déc, 10:00 - 11:30</p>
                <div class="flex space-x-2">
                  <button class="flex-1 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">Accepter</button>
                  <button class="flex-1 px-3 py-1 bg-red-500 text-white text-sm rounded hover:bg-red-600">Refuser</button>
                </div>
              </li>
              ...
              <li class="border-l-4 border-yellow-500 pl-4 py-2">
                <div class="flex items-center mb-2">
                  ...
                  <div>
                    <span class="font-semibold block">Sara Alami</span>
                    <span class="text-sm text-gray-600">Tennis</span>
                  </div>
                </div>
                <p class="text-sm text-gray-600 mb-2">18 Déc, 15:00 - 16:00</p>
                <div class="flex space-x-2">
                  <button class="flex-1 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">Accepter</button>
                  <button class="flex-1 px-3 py-1 bg-red-500 text-white text-sm rounded hover:bg-red-600">Refuser</button>
                </div>
              ...
              <li class="border-l-4 border-yellow-500 pl-4 py-2">
                <div class="flex items-center mb-2">
                  ...
                  <div>
                    <span class="font-semibold block">Youssef Mansouri</span>
                    <span class="text-sm text-gray-600">Natation</span>
                  </div>
                </div>
                <p class="text-sm text-gray-600 mb-2">19 Déc, 08:00 - 09:00</p>
                <div class="flex space-x-2">
                  <button class="flex-1 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">Accepter</button>
                  <button class="flex-1 px-3 py-1 bg-red-500 text-white text-sm rounded hover:bg-red-600">Refuser</button>
                </div>
              ...
              <li class="border-l-4 border-yellow-500 pl-4 py-2">
                <div class="flex items-center mb-2">
                  ...
                  <div>
                    <span class="font-semibold block">Imane Ouardi</span>
                    <span class="text-sm text-gray-600">Préparation Physique</span>
                  </div>
                </div>
                <p class="text-sm text-gray-600 mb-2">20 Déc, 14:00 - 15:30</p>
                <div class="flex space-x-2">
                  <button class="flex-1 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">Accepter</button>
                  <button class="flex-1 px-3 py-1 bg-red-500 text-white text-sm rounded hover:bg-red-600">Refuser</button>
                </div>
              ...
              <li class="border-l-4 border-yellow-500 pl-4 py-2">
                <div class="flex items-center mb-2">
                  ...
                  <div>
                    <span class="font-semibold block">Mehdi Zakaria</span>
                    <span class="text-sm text-gray-600">Sports de Combat</span>
                  </div>
                </div>
                <p class="text-sm text-gray-600 mb-2">21 Déc, 17:00 - 18:30</p>
                <div class="flex space-x-2">
                  <button class="flex-1 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">Accepter</button>
                  <button class="flex-1 px-3 py-1 bg-red-500 text-white text-sm rounded hover:bg-red-600">Refuser</button>
                </div>
        ...
        <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Mon Profil Professionnel</div>
          <div class="p-6 flex-grow overflow-y-auto" style="max-height: 24rem;">
            <div class="space-y-4">
              <div>
                <h4 class="font-semibold text-gray-700 mb-2">Mes Disciplines</h4>
                <div class="flex flex-wrap gap-2">
                  <span class="px-3 py-1 bg-purple-100 text-purple-700 text-sm rounded-full">Football</span>
                  <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm rounded-full">Tennis</span>
                  <span class="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">Natation</span>
                  <span class="px-3 py-1 bg-orange-100 text-orange-700 text-sm rounded-full">Préparation Physique</span>
                </div>
              </div>
              
              <div>
                <h4 class="font-semibold text-gray-700 mb-2">Certifications</h4>
              ...
              <div>
                <h4 class="font-semibold text-gray-700 mb-2">Expérience</h4>
                <p class="text-sm text-gray-600">12 ans d'expérience</p>
                <p class="text-sm text-gray-600">Niveau: Professionnel</p>
              </div>
              
              <div>
                <h4 class="font-semibold text-gray-700 mb-2">Biographie</h4>
                <p class="text-sm text-gray-600">Coach sportif passionné avec plus de 10 ans d'expérience. Spécialisé dans la préparation physique et le coaching personnalisé.</p>
              </div>
      ...
      <section class="bg-white shadow rounded-lg p-6">
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-xl font-semibold">Mes Disponibilités Cette Semaine</h3>
        ...
        <div class="grid grid-cols-7 gap-4">
          <div class="text-center">
            ...
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">08:00-10:00</div>
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">14:00-18:00</div>
            </div>
          </div>
          <div class="text-center">
            <p class="font-semibold text-gray-700 mb-2">Mar</p>
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">09:00-12:00</div>
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">15:00-19:00</div>
            </div>
          </div>
          <div class="text-center">
            <p class="font-semibold text-gray-700 mb-2">Mer</p>
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">08:00-11:00</div>
              <div class="p-2 bg-red-100 text-red-700 text-xs rounded">14:00-16:00 Réservé</div>
            </div>
          </div>
          <div class="text-center">
            <p class="font-semibold text-gray-700 mb-2">Jeu</p>
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">10:00-13:00</div>
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">16:00-20:00</div>
            </div>
          </div>
          <div class="text-center">
            <p class="font-semibold text-gray-700 mb-2">Ven</p>
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">08:00-12:00</div>
              <div class="p-2 bg-red-100 text-red-700 text-xs rounded">14:00-18:00 Réservé</div>
            </div>
          </div>
          <div class="text-center">
            <p class="font-semibold text-gray-700 mb-2">Sam</p>
            <div class="space-y-2">
              <div class="p-2 bg-green-100 text-green-700 text-xs rounded">09:00-13:00</div>
            </div>
          </div>
          <div class="text-center">
...
<!-- Modal Overlay -->
<div id="modal-overlay" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center hidden">
  <!-- Modal Content -->
  <div class="bg-white rounded-lg shadow-lg p-6 w-96 relative">
    ...
    <form id="coach-form" class="space-y-4">
      ...
      <div class="flex justify-end space-x-2">
        <button type="button" id="close-modal" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Annuler</button>
...
<script>
  ...
  btnModifierProfil.addEventListener("click",()=>{
    openModal()
  })
</script>
