    ...
    <section class="bg-white shadow-md">
      <div class="max-w-6xl mx-auto px-4 py-6">
        <div class="flex gap-4 overflow-x-auto">
          <button class="filter-btn active px-6 py-2 rounded-full bg-purple-600 text-white font-medium whitespace-nowrap" data-status="all">
            Toutes
          </button>
          <button class="filter-btn px-6 py-2 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 font-medium whitespace-nowrap" data-status="confirmée">
            Confirmées
          </button>
          <button class="filter-btn px-6 py-2 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 font-medium whitespace-nowrap" data-status="en attente">
            En attente
          </button>
          <button class="filter-btn px-6 py-2 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 font-medium whitespace-nowrap" data-status="annulée">
            Annulées
          </button>
        </div>
      </div>
  ...
  <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
    ...
    <form id="editForm">
      <div class="mb-4">
        ...
        <input type="date" id="editDate" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
      </div>
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-2">Heure de début</label>
        <input type="time" id="editTimeStart" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
      </div>
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-2">Heure de fin</label>
        <input type="time" id="editTimeEnd" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500" required>
      </div>
      <div class="flex gap-3">
        ...
        <button type="button" id="cancelEdit" class="flex-1 px-4 py-2 bg-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-400 transition">
          Annuler
        </button>
      </div>
    </form>
...
<script>
  // Données des réservations (simulées selon le schéma de la BD)
  let reservations = [
    {
      id_reservation: 1,
      id_sportif: 1,
      id_coach: 1,
      coach_name: "Coach Mohamed",
      coach_image: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=300&h=200&fit=crop",
      sport: "Football",
      date_seance: "2025-01-15",
      heure_debut: "10:00",
      heure_fin: "11:00",
      status: "confirmée",
    ...
    },
    {
      ...
      coach_image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=200&fit=crop",
      sport: "Natation",
      date_seance: "2025-01-18",
      heure_debut: "14:00",
      heure_fin: "15:30",
      status: "en attente",
      date_reservation: "2025-01-12"
    },
    {
      id_reservation: 3,
      id_sportif: 1,
      ...
      coach_image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=200&fit=crop",
      sport: "Tennis",
      date_seance: "2025-01-20",
      heure_debut: "16:00",
      heure_fin: "17:00",
      status: "confirmée",
      date_reservation: "2025-01-11"
    },
    {
      id_reservation: 4,
      id_sportif: 1,
      id_coach: 4,
      coach_name: "Coach Amina",
      coach_image: "https://images.unsplash.com/photo-1544005313942-b8d87734a5a2?w=300&h=200&fit=crop",
      sport: "Yoga",
      date_seance: "2025-01-08",
      heure_debut: "09:00",
      heure_fin: "10:00",
      status: "annulée",
      date_reservation: "2025-01-05"
    },
    {
      id_reservation: 5,
      id_sportif: 1,
      id_coach: 5,
      coach_name: "Coach Youssef",
      coach_image: "https://images.unsplash.com/photo-1500648767791-15a19d654956?w=300&h=200&fit=crop",
      sport: "Football",
      date_seance: "2025-01-22",
      heure_debut: "11:00",
      heure_fin: "12:00",
      status: "confirmée",
      date_reservation: "2025-01-13"
    },
    {
      id_reservation: 6,
      id_sportif: 1,
      id_coach: 6,
      coach_name: "Coach Leila",
      coach_image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&h=200&fit=crop",
      sport: "Boxe",
      date_seance: "2025-01-25",
      heure_debut: "17:00",
      heure_fin: "18:30",
      status: "en attente",
      date_reservation: "2025-01-14"
    },
    {
      id_reservation: 7,
      id_sportif: 1,
      ...
      coach_image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=300&h=200&fit=crop",
      sport: "Préparation Physique",
      date_seance: "2025-01-12",
      heure_debut: "08:00",
      heure_fin: "09:00",
      status: "annulée",
      date_reservation: "2025-01-08"
    },
    {
      id_reservation: 8,
      id_sportif: 1,
      id_coach: 8,
      coach_name: "Coach Fatima",
      coach_image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&h=200&fit=crop",
      sport: "Fitness",
  ...
  function createReservationCard(reservation) {
    const canModify = reservation.status !== 'annulée';
